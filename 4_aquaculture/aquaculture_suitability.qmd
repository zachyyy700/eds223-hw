...
Using suitable temperature and depth parameters of oysters, a map displaying the suitable area ($\text{km}^2$) for oyster aquaculture per West Coast region was created. According to the map, the region with the least oyster potential is Northern California and the most is Central California.
...
Using the function, a map showing suitable area ($\text{km}^2$) for rock scallop aquaculture was created. Compared to oysters, rock scallops have a narrower temperature range and prefer shallower waters. Indicated by the deep green, Southern California has the most suitable area for scallop aquaculture followed by Central California.
